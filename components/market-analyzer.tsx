  ...
  return (
    <div className="nn-view">
      ...
      <div className="nn-backtest">
        ...
        {showBacktest && (
          <>
            ...
            {backtestError && (
              <div className="nn-backtest-error">{backtestError}</div>
            )}
      ...
      <style jsx>{`
        ...
        .nn-btn {
          padding: 7px 14px; background: rgba(154,142,210,.1);
          border: 1px solid rgba(154,142,210,.3); border-radius: 6px;
          color: #9a8ed2; font-size: 12px; font-weight: 600; cursor: pointer;
          transition: 0.15s;
        }
        ...
        .nn-empty {
          display: flex; flex-direction: column; align-items: center;
          padding: 40px 20px; text-align: center; color: var(--muted, #718197);
        }
        ...
        .nn-layer {
          ...
          color: #8899aa; font-family: monospace;
        }
        ...
        .nn-stat-card.bad .nn-stat-value { color: #e05555; }
        ...
        /* Loss curve */
        .nn-loss-chart {
          display: flex; gap: 3px; align-items: flex-end; height: 120px;
          padding: 10px; background: #0c141f; border: 1px solid var(--border, #2a3444); border-radius: 8px;
        }
        ...
        /* Per-digit accuracy */
        .nn-digit-accuracy {
          display: flex; gap: 6px; align-items: flex-end; height: 140px;
          padding: 10px; background: #0c141f; border: 1px solid var(--border, #2a3444); border-radius: 8px;
        }
